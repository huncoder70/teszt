...
json_obj3['values[venVAP]'] = "10123"
json_obj3['values[venVst]'] = "20"
json_obj3['values[venOdk1A]'] = 30
json_obj3['values[k1]'] = 40
json_obj3['values[k1mot]'] = 50
json_obj3['values[vtr]'] = 60
...
r = requests.post(url='http://127.0.0.1:8082/kompresory_testing.php', json=json.dumps(json_obj))
#r = requests.post(url='http://127.0.0.1:8081/imi.php', json=json.dumps(json_obj,
#  sort_keys=True, indent=4), headers=headers3)
#r = requests.post(url='http://127.0.0.1:8082/imi.php', data=json_obj3)
#r.headers = headers2
# fo.close()
print(r.status_code)
# print(r.headers)
